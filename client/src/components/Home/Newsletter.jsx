...
const Newsletter = () => {
    return (
        <div className="mt-[80px] py-[30px] bg-[#004461] flex flex-col justify-center items-center">
            <h2 className="text-white text-2xl font-semibold">Join Our Newsletter & Get $10 Discount For Your First Order!</h2>
            <p className="text-white text-[16px]  mt-3 capitalize">Get e-mail updates about our letest shop and special offers.</p>
